        ...
        <div className="mt-8 md:mt-0 md:order-1">
          <div className="flex justify-center md:justify-start">
            <Link to="/" className="flex items-center">
              <span className="text-xl font-bold text-gray-800">Health<span className="text-teal-500">Sphere</span></span>
            </Link>
          </div>
          <nav className="mt-4 flex flex-wrap justify-center md:justify-start gap-6">
            ...
            <Link to="/doctors" className="text-sm text-gray-500 hover:text-gray-900">Doctors</Link>
